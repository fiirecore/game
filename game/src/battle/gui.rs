...
impl BattleClient for BattlePlayerGuiRef {
    fn user(&mut self, battle_type: BattleType, user: BattlePartyKnown) {
        self.get().user(battle_type, user)
    }
