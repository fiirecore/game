...
pub extern crate firecore_pokedex_client as pokengine;
...
use rand::Rng;
use resources::{BattleBackground, GuiLocalPlayer};
...
//     party::PlayerParty,
//     pokemon::{Indexed, remote::InitUnknownPokemon},
//     prelude::{
...
pub use plugins::BattleClientPlugin;
// pub use systems::start_battle;
pub use components::BattleTrainer;
pub use resources::BattleRandom;
...
pub fn load_resources(mut commands: Commands, assets: Res<AssetServer>) {
    commands.insert_resource(resources::BattleBackground {
        background: assets.load("background.png"),
        floor: assets.load("ground.png"),
    });
}
