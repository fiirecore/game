...
use crate::{
	engine::{
		...
		text::TextColor,
		graphics::{draw_text_left, draw_rectangle, draw_rectangle_lines, DARKBLUE, RED},
		tetra::{
...
impl State for MainMenuState {
	...
	fn draw(&mut self, ctx: &mut Context) -> Result {
		...
		draw_rectangle(ctx, 0.0, 0.0, WIDTH, HEIGHT, DARKBLUE);
		...
		draw_rectangle_lines(ctx, 20.0, 5.0 + self.cursor as f32 * Self::GAP, 206.0, 30.0, 2.0, RED);
