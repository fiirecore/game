...
impl BattleTransitions {
    const FLASH: TransitionId = unsafe { TransitionId::from_bytes_unchecked(448612363334u64.to_ne_bytes()) };
    const TRAINER: TransitionId = unsafe { TransitionId::from_bytes_unchecked(32199672233816660u64.to_ne_bytes()) };
}
